...
public class heranca{
    ...
    public static void main(String[] args){
        ...
        cliente cliente = new cliente("João", "111111111-10", 1, 1000); 
        contaEspecial ContaEspecial = new contaEspecial(1, 1000, "Pedro", "222222222-20", 100, 5); 
            ...
            if(control == 1){
                while(controlConta != 0){
                    ...
                    if (controlConta == 1){
                        ...
                        if(cliente.conta.sacar(valorSacar) == false){
                            System.out.println("Saldo insuficiente.");
                        } else {
                            System.out.println("Saque efetuado com sucesso."); 
                        }
                    } else if (controlConta == 3) {
                        cliente.conta.resumoExtrato();
                    }
                }
            }
            else if(control == 2) {
                ...
                investimento Investimento = new investimento(1, 3000, "Marcelo", "333333333-30", 10);
